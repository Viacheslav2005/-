...
<body>
    <div class="header">
        ...
        <button class="head_but" onclick="document.location='../agent/agent_client.php'">Клиенты</button>
        <button type="button" class="head_but" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Создание полиса</button>
        <button class="head_but" onclick="document.location='../agent/agent_insurance.php'">Обновление полиса</button>
        <div class="div_sign">
            <?php 
            if(isset($_SESSION['auth'])) { ?>
                <a href="../agent/agent_client.php"><img src="../design/img/image 2.png" alt=""></a>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action = "../agent/agent_add_insurance.php" method="POST">
